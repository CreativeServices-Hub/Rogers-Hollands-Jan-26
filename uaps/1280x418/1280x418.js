...
lib.ssMetadata = [
		{name:"1280x418_atlas_1", frames: [[0,0,1280,418],[1282,0,1280,418],[2564,0,1280,418],[0,420,1280,418],[1282,420,1280,418],[2564,420,1280,418],[0,840,1280,418],[1282,840,1280,418],[2564,840,1280,418],[0,1260,1280,418],[1282,1260,1280,418]]}
];
...
(lib.RogersandHollandsJan26_0002s_0005_DiscoBall = function() {
	this.initialize(ss["1280x418_atlas_1"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.RogersandHollandsJan26_0002s_0006_Blewelry = function() {
	this.initialize(ss["1280x418_atlas_1"]);
	this.gotoAndStop(8);
}).prototype = p = new cjs.Sprite();
...
(lib.RogersandHollandsJan26_0002s_0007_JewelryMadeforEverydayWearandMeaningfulGifting = function() {
	this.initialize(ss["1280x418_atlas_1"]);
	this.gotoAndStop(9);
}).prototype = p = new cjs.Sprite();
...
(lib.RogersandHollandsJan26_0002s_0009_YourStyleYourYear = function() {
	this.initialize(ss["1280x418_atlas_1"]);
	this.gotoAndStop(10);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.RogersandHollandsJan26_0002s_0005_DiscoBall();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(976,-227,0.85,0.8501);

	this.instance_1 = new lib.RogersandHolland_0000s_0000s_0001_Rectangle1();
	this.instance_1.setTransform(976,-227,0.85,0.8501);
...
p.nominalBounds = new cjs.Rectangle(976,-227,1088,355.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.RogersandHollandsJan26_0002s_0007_JewelryMadeforEverydayWearandMeaningfulGifting();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.RogersandHollandsJan26_0002s_0009_YourStyleYourYear();
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(1024.3,111,0.1304,0.1304,0,0,0,210.8,356.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(71).to({_off:false},0).to({alpha:1},17,cjs.Ease.cubicOut).wait(152));

	// Layer_6
	this.instance_4 = new lib.RogersandHollandsJan26_0002s_0006_Blewelry();

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(240));

	// Layer_4
	this.instance_5 = new lib.RogersandHolland_0001s_0007_EndorsedbyCourtneyCroninESPNReporter();

	this.instance_6 = new lib.RogersandHolland_0001s_0000_Layer7();
	...
	this.instance_7.setTransform(670.05,223.05,0.2404,0.2031,0,0,0,640,209);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(39).to({_off:false},0).to({scaleX:1,scaleY:1,x:640,y:209,alpha:1},20,cjs.Ease.cubicOut).wait(181));

	// Layer_2
	this.instance_8 = new lib.Symbol1("synched",0);
	this.instance_8.setTransform(640,249,1,1,0,0,0,640,209);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({y:209,alpha:1},20,cjs.Ease.cubicOut).wait(220));
...
p.nominalBounds = new cjs.Rectangle(640,-43.8,1503.6999999999998,501.8);
// library properties:
lib.properties = {
