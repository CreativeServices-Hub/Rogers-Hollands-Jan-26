...
(lib.RogersandHollandsJan26_0001s_0001_JewelryMadeforEverydayWearandMeaningfulGifting = function() {
	this.initialize(ss["1280x100_atlas_1"]);
	this.gotoAndStop(6);
}).prototype = p = new cjs.Sprite();
...
(lib.RogersandHollandsJan26_0001s_0002_YourStyleYourYear = function() {
	this.initialize(ss["1280x100_atlas_1"]);
	this.gotoAndStop(7);
}).prototype = p = new cjs.Sprite();
...
(lib.RogersandHollandsJan26_0001s_0003_DiscoBall = function() {
	this.initialize(ss["1280x100_atlas_1"]);
	this.gotoAndStop(8);
}).prototype = p = new cjs.Sprite();
...
(lib.RogersandHollandsJan26_0001s_0005_Rectangle5 = function() {
	this.initialize(ss["1280x100_atlas_1"]);
	this.gotoAndStop(9);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.RogersandHollandsJan26_0001s_0001_JewelryMadeforEverydayWearandMeaningfulGifting();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.RogersandHollandsJan26_0001s_0002_YourStyleYourYear();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(723.05,57.05,0.54,0.54,0,0,0,640.1,50);
	...
	// Layer_6
	this.instance_3 = new lib.RogersandHollandsJan26_0001s_0003_DiscoBall();

	this.instance_4 = new lib.RogersandHollandsJan26_0001s_0005_Rectangle5();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3}]}).wait(240));

	// Layer_1
	this.instance_5 = new lib.RogersandHolland_0001s_0005_EndorsedbyCourtneyCroninESPNReporter();

	this.instance_6 = new lib.RogersandHolland_0001s_0004_Layer8();

	this.instance_7 = new lib.RogersandHolland_0000s_0000_9cdb952fa9a54dd189692d165925a3be();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]}).wait(240));
